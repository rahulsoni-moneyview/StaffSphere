...
import com.example.staffsphere.utils.Constant.DEFAULT_PADDING
import com.example.staffsphere.utils.times
import com.example.staffsphere.utils.transform
import kotlin.math.PI
import kotlin.math.sin
/*
  Animated Bottom bar exp , will use later if time permits
 */
...
fun MainScreen(
    ...
    Box(
        ...
        Circle(
            color = Color(0xFF2c9fff).copy(alpha = 0.5f),
